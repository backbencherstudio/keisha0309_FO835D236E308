    ...
    <div className="w-full max-w-[1320px] mx-auto px-4 lg:px-0 space-y-6 pb-[50px] lg:pb-[100px]">
      ...
      <div className="border border-[#DFE1E7] rounded-xl">
        <div className="flex items-center gap-2 bg-white rounded-xl px-6 py-4">
          ...
          <h1 className="text-2xl font-bold leading-[130%]">Policy Overview</h1>
        </div>
        <hr className="text-[#DFE1E7]" />
        <div className="bg-[#F8FAFB] pt-[18px] pb-[24px] px-6 rounded-xl space-y-3">
          <h1 className="text-lg font-semibold leading-[160%]">
          ...
          <div>
            ...
            <p className="text-[#4A4C56] leading-[160%]">
              Using, possessing, soliciting, or selling illegal drugs, alcohol,
              or unauthorized prescription medications while on duty or on
              company/customer premises.
            </p>
            <p className="text-[#4A4C56] leading-[160%]">
          ...
          <div className="flex items-center gap-2 bg-[#ECEFF3] p-4 rounded-xl">
            <WifiErrorIcon />
            <p className="text-[#4A4C56] leading-[160%]">
              Refusal to comply with testing or a confirmed violation may result
              in disciplinary action, including termination of the driver
              agreement. Drivers will have the opportunity to explain
